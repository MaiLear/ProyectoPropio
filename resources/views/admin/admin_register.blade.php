...
<div class="register">
    ...
    <form action="{{route('admin.store')}}" method="POST" class="register-form" enctype="multipart/form-data">
        ...
        <label class="register__label">First name
            <input class="register-form__input" type="text" name="first_name" placeholder="Enter your first name" required value="{{old('first_name')}}">
        </label>
        <label class="register__label">Second name
            <input class="register-form__input" type="text" name="second_name" placeholder="Enter your second name" required value="{{old('second_name')}}">
        </label>
        <label class="register__label">
            Email
            <input class="register-form__input" type="email" name="email" placeholder="Enter your email" required value="{{old('email')}}">
        </label>
