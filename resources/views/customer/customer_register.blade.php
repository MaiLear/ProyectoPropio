    ...
    <div class="content">
        ...
        <form action="{{route('register.store')}}" method="POST" class="content-form">
            ...
            <label class="content-form__label" for="first_name">First name<br>
                <input class="content-form__input" type="text" name="first_name" id="first_name" placeholder="Enter your first name">
            </label>
            <label class="content-form__label" for="second_name">Second name<br>
                <input class="content-form__input" type="text" name="second_name" id="second_name" placeholder="Enter your second name">
            </label>
            <label class="content-form__label" for="last_name">Last name<br>
                <input class="content-form__input" type="text" name="last_name" id="last_name" placeholder="Enter your last name">
            </label>
            <label class="content-form__label" for="email">Email<br>
                <input class="content-form__input" type="email" name="email" id="email" placeholder="Enter your email">
            </label>
